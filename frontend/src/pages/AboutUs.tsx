          ...
          <div className="relative container mx-auto px-6 flex flex-col space-y-8">
            ...
            {loading ? (
              ...
              timelineData.map((item, index) => {
                ...
                const timelineItemClass = `timeline-item ${
                  isOdd ? "flex-row-reverse" : ""
                }`;
                const timelineContentClass = `timeline-content ${
                  isOdd ? "text-right" : ""
                }`;
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="mt-8 flex space-x-4">
                <a
                  ...
                  className="p-3 bg-gray-200 dark:bg-gray-700 rounded-full hover:bg-primary hover:text-white transition-colors"
                >
                  <FaGithub />
                </a>
                <a
            ...
            <form onSubmit={(e) => e.preventDefault()} className="space-y-5">
              <input
                ...
                required
                className="w-full px-4 py-3 rounded-lg bg-gray-100 dark:bg-gray-900 border-transparent focus:ring-2 focus:ring-primary"
              />
              <input
                type="email"
