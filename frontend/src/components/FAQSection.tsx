...
export default function FAQSection() {
  ...
  return (
    ...
    <section className="mt-10">
      ...
      <div className="mt-6 mb-2 hidden sm:flex items-center gap-3">
        <span className="font-semibold text-lg sm:text-xl text-black-700 dark:text-black-300">Didn’t find what you’re looking for? Ask away!</span>
